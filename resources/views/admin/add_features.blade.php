...
@section('content')
 ...
 <div class="head-banner">
         <ul class="breadcrumb">
            ...
            <li>
               @if($id==0)
               <a href=""><span>Add new Feature</span></a>
               @else
               <a href=""><span>Update Feature</span></a>
               @endif
            </li>
         </ul>
      </div>
      <div class="page mt-4 hosting-page title1 page-with" style="display: block;">
         <div class="list1">
          ...
          @else
              <h4 class="mb-4">Update Feature</h4>
            @endif
         </div>
         <form action="{{url('admin/store_features')}}/{{$id}}" method="post" enctype="multipart/form-data">
         	@csrf
                     ...
                     <div class="row">
                        ...
                        <div class="col-lg-10 data">
                           <input type="text" placeholder="Enter icon" name="icon" value="{{$icon}}" >
                             ...
                             <div>
                                 <a href="https://fontawesome.com/icons">click here to get icon</a>
