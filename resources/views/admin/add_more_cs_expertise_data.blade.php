 ...
 <div class="head-banner">
      ...
      <div class="page mt-4 hosting-page title1 page-with" style="display: block;">
         ...
         <div class="detail table-responsive">
           ...
           <form  action="{{url('admin/store_add_more_cs_expertise_data')}}/{{$id}}" enctype="multipart/form-data" method="POST">
            @csrf
            ...
            <div class="details_main">
               ...
               <div class="part">
                  ...
                  <div class="col-md-12 data">
                     <input type="text" placeholder="Enter Case names" name="name" value="" data-role="tagsinput">
