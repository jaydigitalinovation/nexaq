...
@section('content')
 ...
 <div class="head-banner">
         <ul class="breadcrumb">
            ...
            <li>
               <a href=""><span>Add New Segment</span></a>
            </li>
         </ul>
      </div>
      <div class="page mt-4 hosting-page title1 page-with" style="display: block;">
         <div class="list1">
            <h4 class="mb-4">Add New Segment</h4>
         </div>
         <form action="{{url('admin/store_segment')}}/{{$industry_id}}" method="post" enctype="multipart/form-data">
         	@csrf
