 ...
 <div class="head-banner">
          <ul class="breadcrumb">
              ...
              <li>
                   ...
                   <a href=""><span>Add Service description</span></a>
      ...
      <div class="page mt-4 hosting-page title1 page-with" style="display: block;">
         <div class="list1">
            <h4 class="mb-4">Add Service description</h4>
         </div>
         <div class="detail table-responsive">

           <form  action="{{url('admin/store_sub_service_description')}}/{{$id}}" enctype="multipart/form-data" method="POST" >
                @csrf
