...
@section('content')
 ...
 <div class="head-banner">
         <ul class="breadcrumb">
            ...
            <li>
               <a href=""><span>Update Industries Description</span></a>
            </li>
         </ul>
      </div>
      <div class="page mt-4 hosting-page title1 page-with" style="display: block;">
         <div class="list1">
            <h4 class="mb-4">Update Industries Description</h4>
         </div>
         <form action="{{url('admin/store_update_industries_desc')}}/{{$id}}" method="post">
         	@csrf
