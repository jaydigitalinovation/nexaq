...
@section('content')
  ...
  <div class="head-banner">
         <ul class="breadcrumb">
            ...
            <li>
               <a href=""><span>Who We Are ? Detail</span></a>
            </li>
         </ul>
      ...
      <div class="page mt-4 hosting-page title1" style="display: block;">
         <div class="list1">
            <h4 class="mb-0">Who We Are ? Description</h4>
         ...
         <div class="pro-table table-responsive">
            <table class="table table-bordered table-striped text">
               ...
               @foreach($home_about_description_data as $sd)
                 ...
                 <tr>
                  ...
                  <tr>
                      ...
                      <th><button class="clo btn0"><a href="{{url('admin/update_home_about_description_data')}}/{{$sd->id}}">update</a></button></th>  
      ...
      <div class="page mt-4 hosting-page title1" style="display: block;">
         ...
         <div class="pro-table table-responsive">
            <table class="table table-bordered table-striped">
               ...
               @foreach($home_about_data as $key=>$cd)
                 <tbody class="cs_description_{{$cd->id}}">
                    <tr>
                        ...
                        <td>
                           <a class="icon__1" href="{{url('admin/add_home_about_data')}}/{{$cd->id}}"><i class="fas fa-edit"></i></a>
                          ...
                          $.ajax({
                                ...
                                success: function(response){
                                     ...
                                     $('.cs_description_'+id).hide();
                                       $("#hideDiv strong").empty();
                                       $("#hideDiv strong").append("<p>Record has been deleted successfully!</p>");
                                       $("#hideDiv").css("display","block");
                                       $('#hideDiv').delay(3000).fadeOut(3000);
