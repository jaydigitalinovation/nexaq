...
@section('content')
 ...
 <div class="head-banner">
         <ul class="breadcrumb">
            ...
            <li>
               <a href=""><span>Update Team Description</span></a>
            </li>
         </ul>
      </div>
      <div class="page mt-4 hosting-page title1 page-with" style="display: block;">
         <div class="list1">
            <h4 class="mb-4">Update Team Description</h4>
         </div>
         <form action="{{url('admin/store_team_desc')}}/{{$id}}" method="post" enctype="multipart/form-data">
         	@csrf
