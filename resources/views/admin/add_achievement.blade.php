...
<style type="text/css">
 ...
 <div class="head-banner">
          <ul class="breadcrumb">
              ...
              <li>
                  <a href="#"><span>Add Achievements</span></a>
              </li>
          </ul>
      </div>
      <div class="page mt-4 hosting-page title1 page-with" style="display: block;">
         <div class="list1">
            <h4 class="mb-4">ADD Achievements</h4>
         </div>
         <div class="detail table-responsive">

           <form  action="{{url('admin/store_achievement')}}" enctype="multipart/form-data" method="POST" >
                @csrf
            ...
            <div class="details_main">
                 ...
                 <div class="part">
                  ...
                  <div class="col-md-12 data">
                     <input type="text" placeholder="Enter number" name="number" value="">
               ...
               <div class="part">
                  ...
                  <div class="col-md-12 data">
                     <input type="text" placeholder="Enter Achievements area" name="area" value="">
