...
@section('content')
 ...
 <div class="head-banner">
         <ul class="breadcrumb">
            ...
            <li>
               <a href=""><span>Update Features Description</span></a>
            </li>
         </ul>
      </div>
      <div class="page mt-4 hosting-page title1 page-with" style="display: block;">
         <div class="list1">
            <h4 class="mb-4">Update Features Description</h4>
         </div>
         <form action="{{url('admin/store_features_desc')}}/{{$id}}" method="post" enctype="multipart/form-data">
         	@csrf
