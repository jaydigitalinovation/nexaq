 ...
 <div class="head-banner">
      ...
      <div class="page mt-4 hosting-page title1 page-with" style="display: block;">
         ...
         <div class="detail table-responsive">
           ...
           <form  action="{{url('admin/store_about_blog_detail')}}/{{$id}}" enctype="multipart/form-data" method="POST" >
                @csrf
            ...
            <div class="details_main">
                 ...
                 <div class="part">
                  ...
                  <div class="col-md-12 data">
                     <input type="date" placeholder="Enter Case sub title" name="date" value="{{$date}}">
                ...
                <div class="part part">
                  ...
                  <div class="col-md-12 data data1">
                     <div class="days data1">
                       <textarea type="text" name="detail_description" id="summernote" value="{{$detail_description}}" rows="2">{{$detail_description}}</textarea>   
                     </div>
                  </div>
                </div>
