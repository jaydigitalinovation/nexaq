...
@section('content')
 ...
 <div class="head-banner">
         <ul class="breadcrumb">
            ...
            <li>
               <a href=""><span>UPDATE SERVICE DESCRIPTION</span></a>
            </li>
         </ul>
      </div>
      <div class="page mt-4 hosting-page title1 page-with" style="display: block;">
         <div class="list1">
            <h4 class="mb-4">UPDATE SERVICE DESCRIPTION</h4>
         </div>
         <form action="{{url('admin/store_update_service_desc')}}/{{$id}}" method="post">
         	@csrf
