 ...
 <div class="head-banner">
      ...
      <div class="page mt-4 hosting-page title1 page-with" style="display: block;">
         ...
         <div class="detail table-responsive">
           ...
           <form  action="{{url('admin/store_add_more_cs_result_data')}}/{{$id}}" enctype="multipart/form-data" method="POST">
                @csrf
               ...
               <div class="d-block w-100 my-5 TextBoxContainer">
                            ...
                            <div class="part mx-auto w-75">
                                ...
                                <div class="col-md-12 data">
                                    <textarea type="text" name="result_description" class="summernote1"></textarea>
                                    @if($errors->has('result_description')) <p class="error_mes">{{ $errors->first('result_description') }}</p> @endif
                                </div>
                            </div>
...
<script type="text/javascript" src="https://cdnjs.cloudflare.com/ajax/libs/jquery/3.3.1/jquery.min.js"></script>
  ...
  function GetDynamicTextBox(value) {
    ...
    return '<div class="w-75 mx-auto"><div class="part mx-auto w-75"><div class="part mx-auto w-75"><div class="col-md-12 label"><label>result_description</label></div><div class="col-md-12 data"><textarea type="text" name="result_descriptions[]" class="summernote1"></textarea>@if($errors->has('result_description')) <p class="error_mes">{{ $errors->first('result_description') }}</p> @endif</div></div><a class="add_section remove_section mx-end btnRemove" href="">Remove</a><a class="add_section btnAdd" href="">Add More</a></div>'
}
