 ...
 <div class="head-banner">
      ...
      <div class="page mt-4 hosting-page title1 page-with" style="display: block;">
         ...
         <div class="detail table-responsive">
           ...
           <form  action="{{url('admin/store_case_studies')}}/{{$id}}" enctype="multipart/form-data" method="POST" >
                @csrf
            ...
            <div class="details_main">
                 ...
                 <div class="part">
                   <div class="col-md-12 label">
                     <label>Case sub_title</label>
                   </div>
                  <div class="col-md-12 data">
                     <input type="text" placeholder="Enter Case sub title" name="sub_title" value="{{$sub_title}}">
