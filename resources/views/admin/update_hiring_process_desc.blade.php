...
@section('content')
 ...
 <div class="head-banner">
         <ul class="breadcrumb">
            ...
            <li>
               <a href=""><span>Update Hiring Process Description</span></a>
            </li>
         </ul>
      </div>
      <div class="page mt-4 hosting-page title1 page-with" style="display: block;">
         <div class="list1">
            <h4 class="mb-4">Update Hiring Process Description</h4>
         </div>
         <form action="{{url('admin/store_hiring_process_desc')}}/{{$id}}" method="post">
         	@csrf
